...
correlate <- function(gage_list, project_directory){
  ...
  # list oni values by water year from 1951 - 2010
  ...
  # Rename the columns by water years
  ...
  # empty vector to store correlation values in
  sum_cor <- c()
  # append the oni correlation value
  ...
  # create histograms of the correlation values
  ...
  # combine all correlation data into a df
  ...
  # return the correlation df from the function
